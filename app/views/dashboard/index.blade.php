...
@section("content")
                ...
                <div class="col-sm-4 pull-right">
                    <div class="form-group">
                        <div class="input-group pull-right">
                            <input name="transaction_no" type="number" class="form-control" style="width: 138px;"
                                   placeholder="Transaction No">
                            {{--<button type="button" class="btn btn-success btnTransactionNo"><i class="fa fa-pie-chart"></i></button>--}}
                            <button data-toggle="modal" data-target=".modal-limit-transaction" type="button"
                                    class="btn btn-success btnTransactionNo"><i class="fa fa-pie-chart"></i></button>
                        </div>
                    </div>
                </div>
                <form action="<?php echo URL::to('/transaction/store'); ?>" method="POST" name="transaction"
                      id="transaction">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                <div class="input-group">
                                    <button name="debitBtn" type="button" data-toggle="modal"
                                            data-target=".view-modal-party" class="btn btn-success pull-left"><i
                                                class="fa fa-user"></i></button>
                                    <input required type="text" name="debit" class="form-control" id="debit"
                                           style="width: 200px;" placeholder="Debit">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                <div class="input-group">
                                    <button name="creditBtn" type="button" data-toggle="modal"
                                            data-target=".view-modal-party" class="btn btn-success pull-left"><i
                                                class="fa fa-user"></i></button>
                                    <input required type="text" name="credit" class="form-control" id="credit"
                                           style="width: 200px;" placeholder="Credit">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <select required name="conversion_currency" class="form-control"
                                        id="conversion_currency" style="width: 235px;">
                                    <option>Currency</option>
                                    <?php foreach($data['currency_data'] as $list) { ?>
                                    <option style="display: none;"
                                            value="{{  $list->id }}">{{ $list->currency_code }}</option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div id="foreign_val" class="col-sm-5">
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="foreign_rate"><em><span class="dc">DC</span> To <span
                                                    class="cc">CC</span> </em></label>
                                    <input required name="foreign_rate" type="number" step="0.01" min="0" value=""
                                           class="form-control" id="foreign_rate" placeholder="Foreign Conversion Rate">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input required name="total_amount" type="number" value="" class="form-control"
                                       id="total_amount" placeholder="Total Amount" style="width: 235px;">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input required name="local_rate" type="number" step="0.01" min="0" value=""
                                       class="form-control" id="local_rate"
    ...
    <!-- Start Party Pop Up -->
    <div class="modal fade view-modal-party" tabindex="-1" role="dialog" aria-labelledby="viewSmallModalLabel"
         aria-hidden="true">
                ...
                <div class="modal-body" name="partyModal">
                    <table class="table table-condensed">
                        ...
                        <tr>
                            ...
                            <td>
                                <button currency_id="<?php echo $list->currency_id; ?>"
                                        currency_name="<?php echo $list->currency_code; ?>"
                                        party_id="<?php echo $list->id; ?>"
                                        party_name="<?php echo $list->party_name; ?>" type="button"
                                        class="btn btn-info select_party">Choose
                                </button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
    ...
    <div class="modal fade modal-limit-transaction" tabindex="-1" role="dialog" aria-labelledby="viewSmallModalLabel"
         aria-hidden="true">
...
//                  alert(a);
        ...
        $(".select_party").click(function () {
            ...
            if (partyType == "debitBtn") {
                ...
                $("#c_currency option").each(function () {
                    $(this).removeAttr("selected")
                });
